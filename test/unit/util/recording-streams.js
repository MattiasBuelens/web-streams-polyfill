...
// Original: https://github.com/web-platform-tests/wpt/blob/87a4c80598aee5178c385628174f1832f5a28ad6/streams/resources/recording-streams.js
exports.recordingReadableStream = (extras = {}, strategy) => {
...
exports.recordingWritableStream = (extras = {}, strategy) => {
  let controllerToCopyOver;
...
exports.recordingTransformStream = (extras = {}, writableStrategy, readableStrategy) => {
  let controllerToCopyOver;
